# HTML form
Replace `ediq` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://ediq.github.io/layout_html-form/)
- [TEST REPORT LINK](https://ediq.github.io/layout_html-form/report/html_report/)
